...
Each of us do are assigned tasks and then go over each of the tasks during the weekly meeting to see if everything looks good and we are on track.
We will distribute tasks evenly to match eachother's strengths.
...
We expect each team member to get their tasks done and done well on time, or atleast communicate when they are struggling.
We also expect each member to show up to the meetings on time, if cannot show up give a prior notice.
We expect to be informative on the tasks given and to not change any other group members work without approval.
