...
/**
 * Manages reading and parsing of the simulation configuration file.
 *
 * <p>The configuration file defines lines, routes, stops, and the storage facility
 * used by the transit simulation.
 */
public class ConfigManager {
  ...
  /**
   * Constructs a configuration manager with no data loaded.
   */
  ...
  /**
   * Reads the configuration file, which contains information
   * about lines, routes, stops, and the storage facility.
   *
  ...
  /**
   * Gets the list of lines created from the configuration.
   *
  ...
  /**
   * Gets the storage facility defined in the configuration.
   *
   * @return the storage facility, or {@code null} if none was configured
   */
