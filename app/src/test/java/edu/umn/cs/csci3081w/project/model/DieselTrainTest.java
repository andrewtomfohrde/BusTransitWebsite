...
public class DieselTrainTest {
  ...
  public void setUp() {
    ...
    testTrain = new DieselTrain(1, new Line(10000, "testLine", "TRAIN",
  ...
  public void testReport() {
    ...
    try {
      ...
      testStream.close();
      outputStream.close();
      String strToCompare = "####Diesel Train Info Start####" + System.lineSeparator()
  ...
  public void testCurrentCO2Emission() {
    ...
    assertEquals(9, testTrain.getCurrentCO2Emission());
  }

  /**
   * Tests DieselTrain report includes passengers.
   */
  @Test
  public void testReportWithPassengers() {
    Passenger p1 = new Passenger(1, "Goldy");
    Passenger p2 = new Passenger(2, "President");
    testTrain.loadPassenger(p1);
    testTrain.loadPassenger(p2);
    ...
    try {
      ...
      String expected = "####Diesel Train Info Start####" + System.lineSeparator()
          + "ID: 1" + System.lineSeparator()
          + "Name: testRouteOut1" + System.lineSeparator()
          + "Speed: 1.0" + System.lineSeparator()
          + "Capacity: 3" + System.lineSeparator()
  ...
  public void testGetColorAlphaWithAndWithoutIssue() {
    ...
    DieselTrain trainWithIssue = new DieselTrain(1, lineWithIssue,
        LargeBus.CAPACITY, LargeBus.SPEED);
    assertEquals(155, trainWithIssue.getColor().getAlpha(),
    ...
    DieselTrain trainNoIssue = new DieselTrain(2, lineNoIssue,
        LargeBus.CAPACITY, LargeBus.SPEED);
    assertEquals(255, trainNoIssue.getColor().getAlpha(),
        "Alpha should be 255 when line has no issue");
  }

  /**
   * Tests CO2 emission with multiple passengers.
   */
  @Test
  public void testCO2WithMultiplePassengers() {
    assertEquals(6, testTrain.getCurrentCO2Emission());
    testTrain.loadPassenger(new Passenger(1, "Goldy"));
    testTrain.loadPassenger(new Passenger(2, "President"));
    assertEquals(12, testTrain.getCurrentCO2Emission());
  }
