...
public class ElectricTrainTest {
  ...
  /**
   * Tests ElectricTrain report includes passengers.
   */
  @Test
  public void testReportWithPassengers() {
    ...
    try {
      ...
      String expected = "####Electric Train Info Start####" + System.lineSeparator()
          + "ID: 1" + System.lineSeparator()
          + "Name: testRouteOut1" + System.lineSeparator()
          + "Speed: 1.0" + System.lineSeparator()
          + "Capacity: 3" + System.lineSeparator()
  ...
  public void testGetColorAlphaWithAndWithoutIssue() {
    ...
    ElectricTrain trainWithIssue = new ElectricTrain(1, lineWithIssue,
    ...
    ElectricTrain trainNoIssue = new ElectricTrain(2, lineNoIssue,
        LargeBus.CAPACITY, LargeBus.SPEED);
